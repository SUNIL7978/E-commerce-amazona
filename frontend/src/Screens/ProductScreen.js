                        ...
                        {userInfo ? (
                            <form onSubmit={submitHandler}>
                                ...
                                <div className="mb-3">
                                    ...
                                    {loadingCreateReview && <div><img src="https://m.media-amazon.com/images/G/31/amazonui/loading/loading-4x._CB485930736_.gif" alt="" /></div>}
                                </div>
                            </form>
                        ) : (
                            <MessageBox>
                    ...
                    <ListGroup>
                        {product.reviews.map((review) => (
                            <ListGroup.Item key={review._id}>
                                ...
                                <Rating rating={review.rating} caption=" " className='Star_Rating'></Rating>
